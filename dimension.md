...
## Document size comparisons
  ...
  * Some dimension info is provided in the original raw data for altogether 100000 documents (100%) but could not be interpreted for 65005 documents (ie. dimension info was successfully estimated for 35 % of the documents where this field was not empty).

  * Document size (area) info was obtained in the final preprocessed data for altogether 60063 documents (60%). For the remaining documents, critical dimension information was not available or could not be interpreted: [List of entries where document surface could not be estimated](output.tables/physical_dimension_incomplete.csv)

  * Document gatherings info is originally available for 17979 documents (18%), and further estimated up to 34995 documents (35%) in the final preprocessed data.

  * Document height info is originally available for 43892 documents (44%), and further estimated up to 60063 documents (60%) in the final preprocessed data.

  * Document width info is originally available for 4725 documents (5%), and further estimated up to 60077 documents (60%) in the final preprocessed data.
...
|:-------------------|----------:|------------:|-----------:|-------------:|---:|
|2fo                 |      30.78|        30.78|       33.94|         33.94| 359|
|4to                 |      28.00|        28.00|       22.90|         22.90| 601|
|8vo                 |        NaN|          NaN|       19.65|         19.65| 673|
