...
## Document size comparisons
  ...
  * Some dimension info is provided in the original raw data for altogether 55111 documents (61.1%) but could not be interpreted for 47371 documents (ie. dimension info was successfully estimated for 14 % of the documents where this field was not empty).

  * Document size (area) info was obtained in the final preprocessed data for altogether 34747 documents (39%). For the remaining documents, critical dimension information was not available or could not be interpreted: [List of entries where document surface could not be estimated](output.tables/physical_dimension_incomplete.csv)

  * Document gatherings info is originally available for 7740 documents (9%), and further estimated up to 7740 documents (9%) in the final preprocessed data.

  * Document height info is originally available for 27839 documents (31%), and further estimated up to 34747 documents (39%) in the final preprocessed data.

  * Document width info is originally available for 723 documents (1%), and further estimated up to 34747 documents (39%) in the final preprocessed data.
...
|:-------------------|----------:|------------:|-----------:|-------------:|---:|
|2fo                 |      21.17|        21.17|       32.33|         32.33| 169|
