 ...
 * 54836 [unique publication places](output.tables/publication_place_accepted.csv); available for 5116496 documents (85%).
 ...
 * 61 [unique publication countries](output.tables/publication_country_accepted.csv); available for 4323172 documents (72%).
 * 53860 [places with unknown publication country](output.tables/publication_place_missingcountry.csv) (98.2% of the unique places; can be added to [country mappings](https://github.com/COMHIS/bibliographica/blob/master/inst/extdata/reg2country.csv))
...
|:-----------|-------------:|------------:|
|France      |       1167026|         19.4|
|Germany     |       1147680|         19.1|
|Italy       |        506149|          8.4|
|England     |        497914|          8.3|
|Netherlands |        329422|          5.5|
|Switzerland |         99829|          1.7|
